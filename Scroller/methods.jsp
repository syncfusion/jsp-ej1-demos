...
<div id="property-window" class="box wide">
    <div class="row">
        ...
        <div class="col-sm-2">
            <label for="disableBtn" ></label>
            <ej:toggleButton id="disableBtn" size="small" activeText="Enable" defaultText="Disable " click="onEnabled"></ej:toggleButton>            
        </div>
    </div>
    <div class="row">
        <div class="col-sm-2">
        ...
        <div class="col-sm-2">
        <ej:numericTextbox id="ScrollY" showSpinButton="false" minValue="0" width="95px" change="setScrollY" watermarkText="scrollY"></ej:numericTextbox>         
        </div>
    </div>
    <div class="row">
        <div class="col-sm-2">
        ...
        <div class="col-sm-2">
         <ej:numericTextbox id="ScrollX" showSpinButton="false" minValue="0" width="95px" change="setScrollX" watermarkText="scrollX"></ej:numericTextbox>       
        </div>
    </div>
</div>
