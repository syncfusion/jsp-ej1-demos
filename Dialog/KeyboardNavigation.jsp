...
<ej:dialog id="basicDialog" title="Audi Q3" open="onDialogOpen" target=".cols-sample-area" close="onDialogClose" isResponsive="${resp}" width="400" height="300" allowKeyboardNavigation="true">
