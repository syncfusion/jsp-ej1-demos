...
GetToolbarData2 obj=new GetToolbarData2();
	...
	<div class="control">
		...
		<ej:toolbar id="edittoolsv" dataSource="${ToolbarData}" orientation="vertical" width="52px" >
			<ej:toolbar-fields  id="empid" spriteCssClass="spriteCss" tooltipText="title" ></ej:toolbar-fields>
		</ej:toolbar>
		<br />
		<ej:toolbar id="edittoolsh" dataSource="${ToolbarData}" orientation="horizontal" width="100%">
			<ej:toolbar-fields  id="empid" spriteCssClass="spriteCss" tooltipText="title" ></ej:toolbar-fields>
		</ej:toolbar>
	</div>
</div>
