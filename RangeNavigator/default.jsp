        ...
        <div class="row">
            <div style="border: 0px solid white !important;background:transparent !important">
                <div class="scrollcontent" style="display:block;" align="center">
                	<ej:rangeNavigator id="scrollContent" enableDeferredUpdate="true" load="onrnload" rangeChanged="onchartloaded" padding="15" isResponsive="true" allowSnapping="true">
                		<ej:rangeNavigator-selectedRangeSettings start="2010/5/1" end="2011/10/1"></ej:rangeNavigator-selectedRangeSettings>
                		<ej:rangeNavigator-sizeSettings height="120"></ej:rangeNavigator-sizeSettings>
                		<ej:rangeNavigator-tooltipSettings labelFormat="MM/dd/yyyy" visible="true" tooltipDisplayMode="ondemand"></ej:rangeNavigator-tooltipSettings>
                	</ej:rangeNavigator>
                </div>
                <br/>
                 <div class="container" style="display:block;" align="center">
                	<ej:chart id="container" isResponsive="true" load="onchartload">
                		...
                		<ej:chart-primaryXAxis valueType="datetime" labelFormat="MMM dd">
...
function onchartload(sender){
	sender.model.primaryXAxis.zoomFactor=0.7115384615384616;
		sender.model.primaryXAxis.zoomPosition=0.16483516483516483;
